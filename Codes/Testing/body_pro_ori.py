# -*- coding: utf-8 -*-
"""
Created on Thu Sep  7 09:35:50 2023
...
#image_path = '../../3388.jpg'
image_path = 'C:/Users/Alex/Desktop/Msc APU/Sem 3/Capstone/3246.jpg'
...
def calculate_proportions(keypoints_with_scores):
    ...
    # Get the coordinates
    left_shoulder = valid_keypoints[KEYPOINT_DICT['left_shoulder']]
    right_shoulder = valid_keypoints[KEYPOINT_DICT['right_shoulder']]
    left_hip = valid_keypoints[KEYPOINT_DICT['left_hip']]
    right_hip = valid_keypoints[KEYPOINT_DICT['right_hip']]
    left_ankle = valid_keypoints[KEYPOINT_DICT['left_ankle']]
    right_ankle = valid_keypoints[KEYPOINT_DICT['right_ankle']]
...
propotion = calculate_proportions(keypoints_with_scores)
# # Run model inference.
# keypoints_with_scores = movenet(input_image)
